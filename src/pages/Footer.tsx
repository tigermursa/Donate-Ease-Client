const Footer = () => {
  return (
    <div id="footer">
      <section>
        <div className=" flex-col bg-white px-6 py-20 text-black lg:flex lg:px-10 xl:px-24">
          <div className="lg:flex lg:flex-row lg:justify-between">
            <div>
              <a href="#" className="inline-block max-w-full">
                <img
                  src="https://w7.pngwing.com/pngs/853/96/png-transparent-computer-icons-donation-charitable-organization-donate-miscellaneous-text-logo.png"
                  alt=""
